...
namespace DatosInnovationStrategies
{
    ...
    public partial class InnovationStrategiesDGTEntities : DbContext
    {
        ...
        public virtual ObjectResult<procHistorialInfraccionesConductor_Result> procHistorialInfraccionesConductor(string dNIConductorHabitual, string nombre, string apellido)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<procHistorialInfraccionesConductor_Result>("procHistorialInfraccionesConductor", dNIConductorHabitualParameter, nombreParameter, apellidoParameter);
        }
